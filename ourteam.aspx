<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ourteam.aspx.vb" Inherits="ourteam" %>
...
<body>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary m-0"><i class="fa fa-cross me-3"></i>RCMI</h1>
    ...
    <script src="restoran-1.0.0/restoran-1.0.0//wow/wow.min.js"></script>
    <script src="restoran-1.0.0/restoran-1.0.0/lib/easing/easing.min.js"></script>
    <script src="restoran-1.0.0/restoran-1.0.0//waypoints/waypoints.min.js"></script>
    <script src="restoran-1.0.0/restoran-1.0.0//counterup/counterup.min.js"></script>
    <script src="restoran-1.0.0/restoran-1.0.0//owlcarousel/owl.carousel.min.js"></script>
